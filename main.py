...
values_list = []
names_list = []
my_list_all = ['Полное название', 'Короткое название', 'ИНН', 'ОГРН', 'КПП', 'Дата регистрации', 'Юридический адрес', 'Генеральный директор', 'Учредители', 'Форма', 'Уставный капитал', 'Дата регистрации', 'Налоговая', 'Адрес налоговой', 'Регистрационный номер в ПФР', 'Дата регистрации', 'Наименование территориального органа', 'Регистрационный номер ФссРФ', 'Дата регистрации', 'Наименование территориального органа']
